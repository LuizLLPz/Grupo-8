...
$.ajax({
    ...
    success: function (response) {
        ...
        response.forEach(({titulo, data_publicacao, descricao, nome, foto_arquivo}) => {
            ...
            <div class="card">
                <div class="card_anuncio">
                    <div class="card_anuncio-texto"> 
                        ...
                        <h3 class="texto_card data">${data_publicacao}</h3>
                    ...
                    <div class="card_anuncio-img">
                        ...
                        <div class="azul">
                            <p class="texto_doacao nome_usuario">${nome}</p>
                            <p class="texto_doacao denunciar">Denunciar</p>
                            <div class="foto_anuncio_daocao">
                                <img class="imagem_doacao" src="data:image/png;base64, ${foto_arquivo}" alt="">
                            </div>
                        </div>
                    </div>
            </div>
