...
$.ajax({
    ...
    success: function (response) {
        ...
        response.forEach(({titulo, data, descricao, categoria, usuario, foto_perfil, foto, cidade}) => {
            ...
            <div class="card">
                <div class="card_anuncio">
                    <div class="card_anuncio-texto"> 
                        ...
                        <h3 class="texto_card categoria">${categoria == null ? "Sem categoria" : categoria}</h3>
                        <h3 class="texto_card data">${data.split('-').reverse().join('/')}</h3>
                        <p class="descricao">${descricao}</p>
                        <p class="descricao">Cidade: ${cidade}</p>
                    </div>
